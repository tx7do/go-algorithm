...
func TestInterpolationSort(t *testing.T) {
	type args struct {
		array IntSlice
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			InterpolationSort(tt.args.array, 0, tt.args.array.Len()-1)
			confirmed := true
			...
			if !confirmed {
				t.Errorf("InterpolationSort() = %+v,\n want %+v", tt.args.array, tt.want)
			}
		})
	}
}

func TestInPlaceInterpolationSort(t *testing.T) {
	type args struct {
		array IntSlice
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			InPlaceInterpolationSort(tt.args.array, 0, tt.args.array.Len()-1)
			confirmed := true
			for i := 0; i < tt.args.array.Len(); i++ {
				if tt.args.array[i] != tt.want[i] {
					confirmed = false
			...
			if !confirmed {
				t.Errorf("InPlaceInterpolationSort() = %+v,\n want %+v", tt.args.array, tt.want)
			}
		})
	}
}

func TestInterpolationTagSort(t *testing.T) {
	type args struct {
		array IntSlice
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			InterpolationTagSort(tt.args.array, 0, tt.args.array.Len()-1)
			confirmed := true
			for i := 0; i < tt.args.array.Len(); i++ {
				if tt.args.array[i] != tt.want[i] {
					confirmed = false
			...
			if !confirmed {
				t.Errorf("InterpolationTagSort() = %+v,\n want %+v", tt.args.array, tt.want)
			}
		})
	}
}

func TestInterpolationInsertSort(t *testing.T) {
	type args struct {
		array IntSlice
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			InterpolationInsertSort(tt.args.array, 0, tt.args.array.Len()-1)
			confirmed := true
			for i := 0; i < tt.args.array.Len(); i++ {
				if tt.args.array[i] != tt.want[i] {
					confirmed = false
			...
			if !confirmed {
				t.Errorf("InterpolationInsertSort() = %+v,\n want %+v", tt.args.array, tt.want)
			}
		})
	}
}
...
func TestHistogramSort(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			HistogramSort(tt.args.array, 0, tt.args.array.Len()-1)
			confirmed := true
			for i := 0; i < tt.args.array.Len(); i++ {
				if tt.args.array[i] != tt.want[i] {
					confirmed = false
